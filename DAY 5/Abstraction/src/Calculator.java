...
public class Calculator {
    public static void main(String[] args) {
        Matematika bil = new Matematika();
        System.out.println(ConsoleColors.RED + "RED COLORED" + ConsoleColors.RESET + " NORMAL");
        Scanner scanner = new Scanner(System.in);
        System.out.println(ConsoleColors.BLUE +"+++++++++++++++++++++++++ CALCULATOR +++++++++++++++++++++++++" + ConsoleColors.RESET);
        ...
        if (pilihan == 1){
            ...
            bil.setBilangan1(bilangan1);

            System.out.print("Bilangan 2: ");
            int bilangan2 = scanner.nextInt();
            bil.setBilangan2(bilangan2);
            ...
            if (op == 1){
                System.out.println("Jumlah: " + bil.hitungJumlah());
            }else if (op == 2){
                System.out.println("Jumlah: " + bil.hitungKurang());
            }
        }
    }
}
